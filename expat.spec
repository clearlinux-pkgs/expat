...
Version  : 2.7.1
Release  : 80
URL      : https://sourceforge.net/projects/expat/files/expat/2.7.1/expat-2.7.1.tar.gz
Source0  : https://sourceforge.net/projects/expat/files/expat/2.7.1/expat-2.7.1.tar.gz
Source1  : https://sourceforge.net/projects/expat/files/expat/2.7.1/expat-2.7.1.tar.gz.asc
...
%setup -q -n expat-2.7.1
cd %{_builddir}/expat-2.7.1
pushd ..
cp -a expat-2.7.1 build32
popd
pushd ..
cp -a expat-2.7.1 buildavx2
popd
pushd ..
cp -a expat-2.7.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743111397
...
/usr/lib64/cmake/expat-2.7.1/expat-config-version.cmake
/usr/lib64/cmake/expat-2.7.1/expat-config.cmake
/usr/lib64/cmake/expat-2.7.1/expat-noconfig.cmake
/usr/lib64/cmake/expat-2.7.1/expat.cmake
/usr/lib64/libexpat.so
/usr/lib64/pkgconfig/expat.pc

%files dev32
%defattr(-,root,root,-)
/usr/lib32/cmake/expat-2.7.1/expat-config-version.cmake
/usr/lib32/cmake/expat-2.7.1/expat-config.cmake
/usr/lib32/cmake/expat-2.7.1/expat-noconfig.cmake
/usr/lib32/cmake/expat-2.7.1/expat.cmake
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libexpat.so.1.10.2
/V4/usr/lib64/libexpat.so.1.10.2
