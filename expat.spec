...
Source0  : https://sourceforge.net/projects/expat/files/expat/2.6.2/expat-2.6.2.tar.xz
Source1  : https://sourceforge.net/projects/expat/files/expat/2.6.2/expat-2.6.2.tar.xz.asc
...
cd %{_builddir}/expat-2.6.2
pushd ..
cp -a expat-2.6.2 build32
popd
pushd ..
cp -a expat-2.6.2 buildavx2
popd
pushd ..
cp -a expat-2.6.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710535054
...
/usr/lib64/cmake/expat-2.6.2/expat-config-version.cmake
/usr/lib64/cmake/expat-2.6.2/expat-config.cmake
/usr/lib64/cmake/expat-2.6.2/expat-noconfig.cmake
/usr/lib64/cmake/expat-2.6.2/expat.cmake
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libexpat.so.1.9.2
/V4/usr/lib64/libexpat.so.1.9.2
