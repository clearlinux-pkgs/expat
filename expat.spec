...
Version  : 2.6.4
Release  : 78
URL      : https://sourceforge.net/projects/expat/files/expat/2.6.4/expat-2.6.4.tar.gz
Source0  : https://sourceforge.net/projects/expat/files/expat/2.6.4/expat-2.6.4.tar.gz
Source1  : https://sourceforge.net/projects/expat/files/expat/2.6.4/expat-2.6.4.tar.gz.asc
...
%setup -q -n expat-2.6.4
cd %{_builddir}/expat-2.6.4
pushd ..
cp -a expat-2.6.4 build32
popd
pushd ..
cp -a expat-2.6.4 buildavx2
popd
pushd ..
cp -a expat-2.6.4 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730994290
...
/usr/lib64/cmake/expat-2.6.4/expat-config-version.cmake
/usr/lib64/cmake/expat-2.6.4/expat-config.cmake
/usr/lib64/cmake/expat-2.6.4/expat-noconfig.cmake
/usr/lib64/cmake/expat-2.6.4/expat.cmake
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libexpat.so.1.10.0
/V4/usr/lib64/libexpat.so.1.10.0
/usr/lib64/libexpat.so.1
/usr/lib64/libexpat.so.1.10.0
