...
Version  : 2.6.3
Release  : 77
URL      : https://sourceforge.net/projects/expat/files/expat/2.6.3/expat-2.6.3.tar.xz
Source0  : https://sourceforge.net/projects/expat/files/expat/2.6.3/expat-2.6.3.tar.xz
Source1  : https://sourceforge.net/projects/expat/files/expat/2.6.3/expat-2.6.3.tar.xz.asc
...
%setup -q -n expat-2.6.3
cd %{_builddir}/expat-2.6.3
pushd ..
cp -a expat-2.6.3 build32
popd
pushd ..
cp -a expat-2.6.3 buildavx2
popd
pushd ..
cp -a expat-2.6.3 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725997610
...
/usr/lib64/cmake/expat-2.6.3/expat-config-version.cmake
/usr/lib64/cmake/expat-2.6.3/expat-config.cmake
/usr/lib64/cmake/expat-2.6.3/expat-noconfig.cmake
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libexpat.so.1.9.3
/V4/usr/lib64/libexpat.so.1.9.3
